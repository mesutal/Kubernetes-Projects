...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name:  demo
          image: example/demo:hello-config-env
          ports:
            - containerPort: 8888
          env:
            - name: GREETING
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name:  demo
          image: example/demo:hello-config-file
          ports:
            - containerPort: 8888
          volumeMounts:
          - mountPath: /config/
...
* Use our hello app from example repo. And to call the $GREETINGS env use secrets.